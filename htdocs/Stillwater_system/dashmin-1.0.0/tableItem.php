                ...
                <div class="navbar-nav w-100">
                    <div class="nav-item border-start border-3 border-primary">
                        <div class="nav flex-column ms-4 mt-2">
                            ...
                            <a href="tableItem.php" class="nav-link text-primary bg-primary text-white rounded mb-2 px-3 py-2">Items Table</a>
                            <a href="tablePurchases.php" class="nav-link text-primary rounded mb-2 px-3 py-2">Purchases Table</a>
            ...
            <div class="container-fluid">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 fw-bold text-primary">Item Table</h6>
                    </div>
                    <div class="card-body">
